...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <p>
        We collect the email address you use to sign in, and the care
        information your team logs in CareSync (journal entries, medications,
        shifts, documents). We do not collect payment information directly —
        billing is handled by Stripe.
      </p>

      <h2 id="use">How we use your information</h2>
      <p>
        We use your information to operate CareSync: to authenticate you, to
        deliver the weekly digest email, and to provide support when you contact
        us. We do not use your information for advertising.
      </p>

      <h2 id="sharing">Sharing</h2>
      <p>
        We do not sell your information. We share data with service providers
        (Supabase for database hosting, Resend for email, Stripe for billing)
      ...
      <p>
        ...
        one family&#39;s data cannot be accessed by another family&#39;s
        account.
      </p>
