...
beforeEach(() => {
  ...
  vi.mocked(trpc.medications.delete.useMutation).mockReturnValue({
    mutate: mockDelete,
    isPending: false,
  } as any);
});
...
describe("MedicationPanel — renders expanded by default", () => {
  it('renders "Medications" title without requiring a click', () => {
