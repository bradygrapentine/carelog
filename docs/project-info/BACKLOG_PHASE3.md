...
|-------|--------|-------|--------|
| P3-01 Medication catalog | ❌ NOT STARTED | Claude Code | New router + UI, multi-file |
| P3-02 Admin log | ❌ NOT STARTED | Claude Code + Continue.dev | Checklist UI + care_event writes |
| P3-03 OCR pipeline | ❌ NOT STARTED | Claude Code | Inngest pipeline, file upload, multi-file |
| P3-04 Refill alert | ❌ NOT STARTED | Continue.dev | Follows gapDetector pattern exactly |
| P3-05 Outer circle | ❌ NOT STARTED | Claude Code | New public route, no-auth flow |
| P3-06 Care brief | ❌ NOT STARTED | Claude Code | Vault access pattern, snapshot model |
