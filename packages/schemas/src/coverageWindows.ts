...
/** Validates input for creating a recurring weekly coverage window, enforcing HH:MM times and that end is after start. */
...
/** Validates the query parameters for fetching coverage windows for a specific recipient. */
