...
INSERT INTO tasks (id, org_id, recipient_id, title, created_by, requested_by, status) VALUES
  ...
  ('aa770300-0000-0000-0000-000000000009','aa770100-0000-0000-0000-000000000001',
   'aa770200-0000-0000-0000-000000000001','Reassign-target','aa770001-0000-0000-0000-000000000001','aa770001-0000-0000-0000-000000000001','todo')
ON CONFLICT DO NOTHING;
...
SELECT throws_like(
  $$UPDATE tasks SET assigned_to = 'aa770002-0000-0000-0000-000000000002'
    WHERE id = 'aa770300-0000-0000-0000-000000000009'$$,
  '%tasks_edit_forbidden%',
