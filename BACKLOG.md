...
Last consolidated: **2026-04-16** (codebase scan same day). Last `/backlog-sync`: **2026-05-16 (td-121-membership-cap sprint close)** — `/sprint td-121-membership-cap` shipped TD-121 (PR #518). Opus pre-merge review (0 must-fix / 3 should-fix) caught that `.limit(50)` alone IS the per-second Auth Admin rate limit, not under it; expanded to three-fix bundle (cap + chunked-allSettled at in-flight=8 + console.warn observability). §0 Ready: 28 → 27 (-1 shipped).
...
|---|---|---|
| 🟢 Ready | 27 | TD-111 · TD-120/123 · TD-129 · TD-133 · TD-137/138 · TD-141 · UX-048..050 · UX-053 · UX-065 · UX-077 · UX-103b/104b/105b · SEC-007 · SEC-008 · SEC-009 · SEO-005 · PP-009 · ON-70 · ON-71 · ON-74 (+ rows in §3–§5 not enumerated) |
| 🔎 In review | 0 | — |
