...
Last consolidated: **2026-04-16** (codebase scan same day). Last `/backlog-sync`: **2026-05-16 (journal-types-perf sprint close)** — `/sprint journal-types-perf` shipped TD-138 + TD-137 (PR #520, two commits). Pure-refactor bundle from the journal-meds-quick-wins /oop review. Opus pre-merge review (2 cycles: 1 must-fix → 0/1/1) caught that EntryDetailClient was the lone byte-different JournalEvent definition. §0 Ready: 27 → 25 (-2 shipped).
...
|---|---|---|
| 🟢 Ready | 25 | TD-111 · TD-120/123 · TD-129 · TD-133 · TD-141 · UX-048..050 · UX-053 · UX-065 · UX-077 · UX-103b/104b/105b · SEC-007 · SEC-008 · SEC-009 · SEO-005 · PP-009 · ON-70 · ON-71 · ON-74 (+ rows in §3–§5 not enumerated) |
| 🔎 In review | 0 | — |
