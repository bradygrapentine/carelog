...
Last consolidated: **2026-04-16** (codebase scan same day). Last `/backlog-sync`: **2026-05-15 (careteam-rls-defense sprint close)** — `/sprint careteam-rls-defense` shipped TD-120 + TD-129 (PRs #522/#523). Defense-in-depth pair: session-scoped supabase + RLS gate on `getCareTeamForRecipient`, and pgTAP cases 7–9 + REVOKE migration closing a real `accept_invite` grant gap (Supabase default privileges had silently overridden the original REVOKE FROM PUBLIC). §0 Ready: 25 → 24 (-2 shipped + 1 new TD-142 from /oop --from-sprint).
...
|---|---|---|
| 🟢 Ready | 24 | TD-111 · TD-123 · TD-133 · TD-141 · TD-142 · UX-048..050 · UX-053 · UX-065 · UX-077 · UX-103b/104b/105b · SEC-007 · SEC-008 · SEC-009 · SEO-005 · PP-009 · ON-70 · ON-71 · ON-74 (+ rows in §3–§5 not enumerated) |
| 🔎 In review | 0 | — |
