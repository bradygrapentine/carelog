...
Last consolidated: **2026-04-16** (codebase scan same day). Last `/backlog-sync`: **2026-05-10 PM-2 (stale-Ready sweep)** — 7 stories shipped today across PRs #438–#448 (UX-113/114/115, A11Y-020, A11Y-021, TD-118, TD-119). Plus 6 stale-Ready rows reconciled this pass: TD-112/113/114/115/116/117 — referenced files already exist on main from earlier PRs (#418, #433, #436, etc.); rows were never flipped. The /backlog-sync skill's §3a stale-Ready detector caught 5 of 6 (TD-117 missed because its row body has no literal `New file:` callout). Remaining Ready = 21.
...
|---|---|---|
| 🟢 Ready | 21 | TD-111 · UX-041..044 · UX-048..050 · UX-053 · UX-065 · UX-077 · UX-103..105 · SEO-005 · PP-009 · ON-70 · ON-71 · ON-74 (+ rows in §3–§5 not enumerated) |
| 🔎 In review | 0 | — |
