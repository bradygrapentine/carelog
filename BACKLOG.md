...
| ON-52 | ✅ Shipped · PR #TBD | — | feat/on52-history-counter | **Care history depth counter on dashboard** | Shows care event count + months of history per team; parallel Supabase queries + `formatCareStats` pure helper + 6 unit tests. |
