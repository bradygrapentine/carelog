...
Last consolidated: **2026-04-16** (codebase scan same day). Last `/backlog-sync`: **2026-05-10 PM (smoke-walk + TD-118/119 wave)** — 7 stories shipped today across PRs #438–#448 (UX-113/114/115, A11Y-020, A11Y-021, TD-118, TD-119). Remaining Ready = 27 (the prior board claimed 26 but the actual grep was 34; flipping 7 today landed at 27).
...
|---|---|---|
| 🟢 Ready | 27 | TD-111 · TD-112 · TD-113..116 · UX-041..044 · UX-048..050 · UX-053 · UX-065 · UX-077 · UX-103..105 · SEO-005 · PP-009 · ON-70 · ON-71 · ON-74 (+ rows in §3–§5 not enumerated) |
| 🔎 In review | 0 | — |
