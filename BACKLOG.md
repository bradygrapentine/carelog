...
✅ **TD-17** Mobile Jest 0→33 suites green: Math.round in scaledFont, virtual expo-device mock, stale screen text + missing trpc mocks fixed, BottomSheet mocked in journal tests (PR TBD)
