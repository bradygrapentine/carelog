...
Last consolidated: **2026-04-16** (codebase scan same day). Last `/backlog-sync`: **2026-05-15 (stale-Ready cleanup)** — closed 4 stale-Ready rows surfaced by Opus review of the execution graph: UX-103/104/105 were duplicates of §7 entries (PRs #451/#452/#453 had shipped them); TD-123 had inline notes confirming part (a) shipped via PR #456 and part (b) is a no-op. SEC-001 remains flagged stale (P0 In progress since 2026-05-10 — awaiting operator action on secret rotation). §0 Ready: 23 → 22.
...
|---|---|---|
| 🟢 Ready | 22 | TD-111 · TD-133 · TD-141 · TD-142 · UX-049/050 · UX-053 · UX-065 · UX-077 · UX-103b/104b/105b · SEC-007 · SEC-008 · SEC-009 · SEO-005 · PP-009 · ON-70 · ON-71 · ON-74 (+ rows in §3–§5 not enumerated) |
| 🔎 In review | 0 | — |
