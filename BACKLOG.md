...
Last consolidated: **2026-04-16** (codebase scan same day). Last `/backlog-sync`: **2026-05-14 PM (pre-staging-mitigations sprint close)** — `/sprint pre-staging-mitigations` shipped TD-134/135/136 via PRs #500/#499/#497 (parallel /wave §3b, 4 file-disjoint Sonnet tracks); T4 of the same sprint shipped the SEC-009 runbook guidance via #498 but SEC-009 itself (Vercel dashboard UI work to populate the Development env tier) stays Ready until the operator walks runbook §9. Housekeeping PR #501 added ADR-0004 to `docs/adr/README.md` index. Remaining Ready = 31.
...
|---|---|---|
| 🟢 Ready | 33 | TD-111 · TD-120..123 · TD-129/130 · TD-133 · TD-137/138 · UX-041..044 · UX-048..050 · UX-053 · UX-065 · UX-077 · UX-103b/104b/105b · SEC-007 · SEC-008 · SEC-009 · SEO-005 · PP-009 · ON-70 · ON-71 · ON-74 (+ rows in §3–§5 not enumerated) — UX-041/042/043 will drop to 30 once `/backlog-sync` promotes today's shipped sprint to §7 |
| 🔎 In review | 0 | — |
